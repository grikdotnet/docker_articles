...
A few years ago came the devops guys, administrators with programmers way of thinking, want to replace the conventional procedural command calls from bash with an OOP.
