...
A few years ago came the devops guys, and wished to replace a conventional procedural command calls from bash with an OOP design applied to the infrastructure.
