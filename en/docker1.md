...
A common moot point is whether Nginx configuration files are a part of a web application. System administrators are disputing with application developers on responsibility and permissions.
Then come the devops guys and want to replace the conventional procedural command calls from bash with an OOP.
