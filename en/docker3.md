...
Docker has a very interesting tool called a [Data Volume сontainer](https://docs.docker.com/userguide/dockervolumes/#creating-and-mounting-a-data-volume-container). 
For me it is corresponds to a Data Transfer Object pattern in a system design.

**Data Volume**

The volume is an external folder or file, mounted inside the container.
There are three types of data volume:
