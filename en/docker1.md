...
A common moot point is whether Nginx configuration files are a part of a web application. System administrators are disputing with application developers on permissions and areas of responsibility.
A few years ago came the devops guys, administrators with programmers way of thinking, and want to replace the conventional procedural command calls from bash with an OOP.
