...
Docker provides encapsulation, inheritance and polymorphism to system components, such as database or data. You can decompose a whole information system, make your application, web server, database, system libraries and data independent components. You may inject dependencies from configs and make it work in a group, identically on different servers.
